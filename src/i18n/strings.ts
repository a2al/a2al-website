...
const en: SiteStrings = {
  ...
  about: {
    ...
    builtItems: [
      'Decentralized address resolution (DHT)',
      'Encrypted P2P connections (QUIC + TLS 1.3)',
      'Sovereign identity (Ed25519 native)',
      'Service discovery (Topic Rendezvous)',
      'Encrypted async messaging (Mailbox)',
      'AI-native daemon (REST + MCP + WebUI)',
      'Public bootstrap network',
    ],
    plannedTitle: 'Planned',
    plannedItems: [
      'TURN relay (connectivity under strict NAT)',
...
const ja: SiteStrings = {
  ...
  about: {
    ...
    builtItems: [
      '分散型アドレス解決（DHT）',
      '暗号化ピアツーピア接続（QUIC + TLS 1.3）',
      'ソブリン・アイデンティティ（Ed25519ネイティブ）',
      'サービスディスカバリー（Topic Rendezvous）',
      '暗号化非同期メッセージング（Mailbox）',
      'AIネイティブデーモン（REST + MCP Server + WebUI）',
      'パブリック・ブートストラップ・ネットワーク',
    ],
    plannedTitle: '計画中',
    plannedItems: [
      'TURNリレー（厳格なNAT下での接続性確保）',
